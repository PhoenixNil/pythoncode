...
USAGE = """Usage: python captioning.py [...]
  ...
  OUTPUT
    ...
    --threshold NUMBER               Set stable partial result threshold.
                                     Default is 3.
    example:  python captioning.py --input caption.this.mp4 --format any --output caption.output.txt --srt --realTime --threshold 5 --delay 0 --profanity mask --phrases "Contoso;Jessie;Rehaan"
"""
